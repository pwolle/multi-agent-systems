...
plt.legend(frameon=False, title=f"Tc={Tc}")
plt.savefig("plots/1c.pdf", transparent=True, bbox_inches="tight")

# %%
fig, ax = plt.subplots(figsize=(4, 4))

ax.plot([3, 5, 10, 20, 30], ends, marker="o")

ax.set_xlabel("Number of agents")
ax.set_ylabel("Number of tasks completed")

plt.title("Varying number of agents with $Tc=3$")

sns.despine()

plt.savefig("plots/1c_ends.pdf", transparent=True, bbox_inches="tight")
